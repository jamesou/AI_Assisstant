...
def main():
    ...
    file_path = os.path.join(script_dir, "ai-news-complete-tables.sql")
    ...
    execute_sql_script(cursor, file_path)
    conn.commit()
    file_path = os.path.join(script_dir, "ai-news-complete-mock-data.sql")
